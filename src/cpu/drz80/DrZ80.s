...
;@ http://oopsware.googlepages.com
      ...
      .equiv INTERRUPT_DOZE, 		1		;@0 = Use internal int handler, 1 = Use Doze int handler
...
;@ --------------------------- Defines ----------------------------
    ...
    .equ nEI,			 		  z80irqvector+4
	.equ nCyclesLeft,		  	  nEI+4
	.equ nCyclesTotal,	 		  nCyclesLeft+4
	.equ nCyclesSegment,	 	  nCyclesTotal+4
	.equ nInterruptLatch,	 	  nCyclesSegment+4

	.equ z80irqcallback,          nInterruptLatch+4
